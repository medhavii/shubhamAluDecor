...
const windows = [
  ...
  {
    name: "Custom",
    description: "Make your own window. Customise it as you like.",
        ...
        <div className=" flex w-11/12  justify-center">
          <div className="w-4/6 flex flex-col justify-center m-2 p-2">
            ...
            <p className="text-xl text-gray-600 ">
              Discover your perfect window style with our wide range of options
              at Shubham Aludecor. Elevate the look and feel of your living
              space with unique features that can transform your home's ambiance
              and aesthetic. Browse our selection to find the window style that
              suits your needs and customize it to your liking. Our commitment
